...
env.workspace = wd
#Usual variables
gages= datadir+'sharepoint20180316\gis\hydro\\rufiji\RRB_RBWB_RGS.shp'
...
arcpy.CopyRows_management(gages_netjoin, wd+'gages_netjoin.dbf')
#Export rest of environmental data to dbf
arcpy.CopyRows_management(slinerufifinal, wd+'streamnet118_rufiji_finaltab.dbf')